			...
			<header>
				<div class="center_box">
					<div class="wrapper">
						...
						<div class="logo_box">
							<a href="{{ URL::to('/task') }}" target="_blank"><img src="{{ URL::asset('/img/logo.png') }}" alt="foodclub" /></a>
						</div>
							...
							<div class="upan">
								...
								<div class="navbox">
									<a href="#" class="midbox nftoggle">
										<img src="{{ URL::asset('/imgc/user_ava_1_40.jpg') }}" alt="" />
				...
				<div class="page_content bg_gray">
					<div class="uo_header">
						<div class="wrapper cf">
							<div class="wbox ava">
								<figure><img src="{{ URL::asset('/imgc/user_ava_1_140.jpg') }}" alt="Helena Afrassiabi" /></figure>
							</div>
							<div class="main_info">
							...
							<div class="uofb cf">
								<div class="l_col adrs">
									...
									<form action="/addAddress" method="post">
										{{csrf_field()}}
										<input type="hidden" name="title-area">
										<div class="field">
											<label>Name *</label>
											<input type="text" value="" name="name" palceholder="" class="vl_empty" />
										</div>
										<div class="field">
										...
										<div class="field">
											...
											<select name="cities" class="vl_empty cities">
												<option class="plh"></option>
											</select>
										</div>
								...
								<div class="r_col">
									...
									<div class="uo_adr_list">
										...
										<div class="item">
											<h3>{{$addres->name}}</h3>
											<p>{{$addres->city}}, {{$addres->area}} область, {{$addres->street}}, {{$addres->house}}, {{$addres->information}} </p>
											<button class="button" data-lat="{{$addres->lat}}" data-lng="{{$addres->lng}}">Карта</button>
											<div class="actbox">
												<a href="{{route('DeleteAddress', ['id' => $addres->id])}}" class="bcross"></a>
											</div>
										</div>
										@endforeach
									</div>
